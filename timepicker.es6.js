    ...
    render() {
        ...
        return (
            <p className="timepicker-info" style={{ width: size }}>
                <span
                    className={`timepicker-info-digits${
                        mode === Timepicker.HOURS ? ' active' : ''
                    }`}
                ...
                <span
                    className={`timepicker-info-digits${
                        mode === Timepicker.MINUTES ? ' active' : ''
                    }`}
...
export class Clock extends React.Component {
    ...
    componentDidUpdate(previousProps, previousState) {
        ...
        hand1.setAttribute(
            ...
            mode
                ? positionsHours[
                      hours === 0 ? (militaryTime ? 23 : 11) : hours - 1
                  ][0]
    ...
    renderMinutesBubbles() {
        ...
        for (let minute = 0; minute < positions.length; ++minute) {
            ...
            bubbles.push(
                <g
                    className={`timepicker-bubble${minute % 5 ? ' small' : ''}${
